...
val supportedApis =
    listOf(
        ApiSpec(
            name = "XKCD Data Hub Lite API",
            taskName = "generateXkcdDataHubLiteApi",
            directoryPath = apiDirectoryPath,
            outputDir = "$openApiGenerateOutputDir/xkcd-data-hub-lite",
            specFileName = "xkcd-data-hub-api.yaml",
            generatorType = "kotlin-spring",
            packageName = "com.xkcddatahublite.adapters.input.http.rest.openapi.v1",
            modelPackageName = "com.xkcddatahublite.adapters.input.http.rest.openapi.v1.models",
            config =
            mapOf(
